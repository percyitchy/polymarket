#!/usr/bin/env python3
"""
HashDive Insiders Scraper using Firefox (Google OAuth friendly)
"""
...
async def scrape_hashdive():
    """Scrape HashDive Insiders page using Firefox"""
    
    print("=" * 60)
    print("HashDive Insiders Scraper (Firefox)")
    print("=" * 60)
    print("\n📋 Инструкция:")
    print("1. Браузер Firefox откроется с сайтом HashDive")
    print("2. Вы войдете через Google OAuth")
    print("3. После логина подождите 30 секунд")
    print("4. Скрипт автоматически соберет данные")
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            if "Log in" in page_text:
                ...
                print("   (Firefox обычно работает лучше с Google login)")
...
def main():
    ...
    print("✅ Firefox лучше работает с Google OAuth")
    print("=" * 60)
